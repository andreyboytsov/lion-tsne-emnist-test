...
## Figure 10
File: ./figures/outlier-test-all.png  
Figure generated by: ./figure-generators/gen-outlier-test-all.py

## Figure - letter test outcome (not in the article yet)
Pretty much the same as figure 7 or 10, but for letter test.
File: ./figures/letter-test-all.png  
Figure generated by: ./figure-generators/gen-letter-test-all.py

## Figure - letter test example (not in the article yet)
Like figure 9, but for letter test.
File: ./figures/letter_examples.png  
Figure generated by: ./figure-generators/letter_examples.py
...
## Table for letter test (not in the article yet)
