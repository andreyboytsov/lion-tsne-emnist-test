...
letter_A_results_file_prefix = '../results/letter_A_IDW_higher'
...
if __name__ == "__main__":
    ...
    letter_A_lion_RBF_IDW_commons.main(regenerate=False, parameters=settings.parameters,
         generate_all_embedders=generate_all_embedders,
         letter_A_results_file_prefix=letter_A_results_file_prefix,
