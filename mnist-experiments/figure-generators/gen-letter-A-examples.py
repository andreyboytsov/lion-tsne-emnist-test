...
_, letter_A_samples_raw = generate_data.load_A_letters(parameters=settings.parameters)
...
if height > 1:
    for i in range(height):
        for j in range(width):
            ax[i,j].imshow(letter_A_samples_raw[i*width+j,:].reshape(28,28), cmap='gray_r')
...
f.savefig("../figures/letter_A_examples.png")