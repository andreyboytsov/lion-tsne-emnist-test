...
plt.gcf().set_size_inches(2.5,2.1) #Let's set the plot sizes that just fit paper margins
legend_list = list()
...
plt.tight_layout(rect=[-0.25, -0.17, 1.05, 1.07])

plt.tick_params(axis='both', which='both',bottom=False,top=False,labelbottom=False,
                                          left=False,right=False,labelleft=False)

plt.savefig('../figures/mnist_tsne_original.png')