...
h3 = ax[rbf_X][rbf_Y].scatter(letters_y_inverse[:shown_letter_A_indices, 0],
                letters_y_inverse[:shown_letter_A_indices, 1], c='blue', zorder=1, label=None, marker='.',
                             s=point_size_interest)
h4 = ax[rbf_X][rbf_Y].scatter(letters_y_linear[:shown_letter_A_indices, 0],
                letters_y_linear[:shown_letter_A_indices, 1], c='green', zorder=1, label=None, marker='.',
                             s=point_size_interest)
h5 = ax[rbf_X][rbf_Y].scatter(letters_y_cubic[:shown_letter_A_indices, 0],
                letters_y_cubic[:shown_letter_A_indices, 1], c='purple', zorder=1, label=None, marker='.',
                             s=point_size_interest)
h6 = ax[rbf_X][rbf_Y].scatter(letters_y_thin_plate[:shown_letter_A_indices,0],
                letters_y_thin_plate[:shown_letter_A_indices,1], c='cyan', marker='.', zorder=3,alpha=0.9,
                             s=point_size_interest)
h7 = ax[rbf_X][rbf_Y].scatter(letters_y_quintic[:shown_letter_A_indices, 0],
...
cur_shown_letter_A_indices = shown_letter_A_indices
