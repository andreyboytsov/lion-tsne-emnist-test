...
outliers_y_idw70 = all_RBF_IDW_results['IDW-70']['EmbeddedPoints']
...
h3 = ax[idw_Y][idw_X].scatter(outliers_y_idw70[:shown_outlier_indices, 0],
                outliers_y_idw70[:shown_outlier_indices, 1], c='green', zorder=1, label=None, marker='.',s=point_size_interest)
...
h5 = ax[idw_Y][idw_X].scatter(kernelized_tsne_outliers_results[0][:shown_outlier_indices, 0],
                kernelized_tsne_outliers_results[0][:shown_outlier_indices, 1], c='cyan', zorder=1, label=None, marker='.',
                                 s = point_size_interest)
h6 = ax[idw_Y][idw_X].scatter(kernelized_tsne_outliers_results[1][:shown_outlier_indices, 0],
                kernelized_tsne_outliers_results[1][:shown_outlier_indices, 1], c='orange', zorder=1, label=None, marker='.',
                                 s = point_size_interest)
