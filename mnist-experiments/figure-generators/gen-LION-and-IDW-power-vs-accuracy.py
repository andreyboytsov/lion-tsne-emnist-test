...
idw_power_plot_data = exp_idw_power_performance.load_idw_power_performance(parameters=parameters)
...
plt.legend([h,h2]+legend_lines,["Baseline Accuracy (%.4f)"%baseline_accuracy, "IDW interpolation"]+legend_list,
