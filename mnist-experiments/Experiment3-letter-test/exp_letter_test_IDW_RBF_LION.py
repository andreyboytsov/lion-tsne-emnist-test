...
letter_results_file_prefix = '../results/letter_'
...
def get_common_info(parameters):
    ...
    letter_samples, _ = generate_data.load_letters(parameters=settings.parameters)
...
def main(*, regenerate=False, parameters=settings.parameters):
    ...
    letter_results_file = generate_letter_results_filename(parameters)
